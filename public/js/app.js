...
function main() {
  ...
  loader2.load('js/bc.jpg', function (texture) {
  ...
  audioLoader.load('js/sounds/intro.mp3', function (buffer) {
  ...
  // Water
  {
    ...
    water = new Water(
      waterGeometry,
      {
        textureWidth: 4096,
        textureHeight: 2160,
        waterNormals: new THREE.TextureLoader().load("js/textures/water/waternormals.jpg", function (texture) {
  ...
  function loadShark() {

    {
      new RGBELoader()
        ...
        .setPath('js/textures/equirectangular/')
        .load('js/pedestrian_overpass_2k.hdr', function (texture) {

          var options = {
            minFilter: texture.minFilter,
            magFilter: texture.magFilter
          };
          var loader = new GLTFLoader().setPath('js/shark/');
  ...
  function loadBoat() {

    {
      ...
      mtlLoader.load('js/models/ship/Cruiser_2012.mtl', (mtlParseResult) => {
        const objLoader = new OBJLoader2();
        const materials = MtlObjBridge.addMaterialsFromMtlLoader(mtlParseResult);
        objLoader.addMaterials(materials);
        objLoader.load('js/models/ship/Cruiser 2012.obj', (root) => {
  ...
  function loadFemale() {
    {
      const mtlLoader = new MTLLoader();
      mtlLoader.load('js/female/female02.mtl', (mtlParseResult) => {
        const objLoader = new OBJLoader2();
        const materials = MtlObjBridge.addMaterialsFromMtlLoader(mtlParseResult);
        objLoader.addMaterials(materials);
        objLoader.load('js/female/female02.obj', (root) => {
          root.scale.set(0.01, 0.01, 0.01);
  ...
  function loadCity() {
    ...
    {
      const mtlLoader = new MTLLoader();
      mtlLoader.load('js/models/city/city.mtl', (mtlParseResult) => {
        const objLoader = new OBJLoader2();
        const materials = MtlObjBridge.addMaterialsFromMtlLoader(mtlParseResult);
        objLoader.addMaterials(materials);
        objLoader.load('js/models/city/city.obj', (root) => {
  ...
  function loadIsland() {
    {
      ...
      mtlLoader2.load('js/models/Small Tropical Island/Small_Tropical_Island.mtl', (mtlParseResult) => {
        const objLoader = new OBJLoader2();
        const materials = MtlObjBridge.addMaterialsFromMtlLoader(mtlParseResult);
        objLoader.addMaterials(materials);
        objLoader.load('js/models/Small Tropical Island/untitled.obj', (mesh) => {
  ...
  var cubeMaterial = [
    new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/textures/px.JPG"), side: THREE.DoubleSide }),
    new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/textures/nx.JPG"), side: THREE.DoubleSide }),
    new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/textures/py.JPG"), side: THREE.DoubleSide }),
    new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/textures/ny.JPG"), side: THREE.DoubleSide }),
    new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/textures/pz.JPG"), side: THREE.DoubleSide }),
    new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/textures/nz.JPG"), side: THREE.DoubleSide })
  ...
  var planeMaterial = [
    new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/textures/bolt.png"), side: THREE.DoubleSide, alphaTest: 0.4 }),
    new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/textures/bolt.png"), side: THREE.DoubleSide, alphaTest: 0.4 })
  ];
  ...
  window.setTimeout(function () {
    ...
    var sound = new THREE.Audio(audioListener);
    var audioLoader = new THREE.AudioLoader();
    audioLoader.load('js/sounds/bolt.mp3', function (buffer) {
      sound.setBuffer(buffer);
      sound.setLoop(false);
      sound.setVolume(1.5);
      sound.play();
  ...
  window.setTimeout(function () {
    ...
    ; var nightCubeMaterial = [
      new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/textures/back.png"), side: THREE.DoubleSide }),
      new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/textures/back.png"), side: THREE.DoubleSide }),
      new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/textures/top.png"), side: THREE.DoubleSide }),
      new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/textures/bottom.png"), side: THREE.DoubleSide }),
      new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/textures/top.png"), side: THREE.DoubleSide }),
      new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/textures/left.png"), side: THREE.DoubleSide })
  ...
  var cubeMaterial = [
    new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/box.JPG"), side: THREE.DoubleSide }),
    new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/box.JPG"), side: THREE.DoubleSide }),
    new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/box.JPG"), side: THREE.DoubleSide }),
    new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/box.JPG"), side: THREE.DoubleSide }),
    new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/box.JPG"), side: THREE.DoubleSide }),
  ...
  const material = new THREE.MeshBasicMaterial({ map: new THREE.TextureLoader().load("js/models/sea.JPG"), side: THREE.DoubleSide });
  ...
  var rainDrop = new THREE.TextureLoader().load('js/textures/drop.png');
...
window.setTimeout(function () {
  ...
  var sound = new THREE.Audio(audioListener);
  var audioLoader = new THREE.AudioLoader();
  audioLoader.load('js/sounds/rain.mp3', function (buffer) {
    sound.setBuffer(buffer);
    sound.setLoop(false);
    sound.setVolume(1.5);
    sound.play();
